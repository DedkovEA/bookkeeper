...
class AbstractCategoryModel(typing.Protocol):
    ...
    def get_whole_subtree(
            self, 
            category: typing.Optional[AbstractCategory]=None) -> list[AbstractCategory]:
        ...
    ...
    def delete_category(self, cat: AbstractCategory,
                        children_policy: CategoryDeletePolicy =
                        CategoryDeletePolicy.delete) -> tuple[int, int]:
        """
    ...
    def rename_category(self, cat: AbstractCategory, new_name: str) -> AbstractCategory:
        ...

    def update_category(self, cat: AbstractCategory, 
                        upd_data: dict[CategoryField, typing.Any]) -> AbstractCategory:
        ...