...
g = GUI_Based_View()
m = PonyModel(provider="sqlite", filename="database.sqlite", create_db=True)
p = Presenter(g, m)

# test_exps = [
#     ViewExpense(0, "123", "Milk", "21/02/2024", "Yammy!"),
#     ViewExpense(1, "183,44", "Book", "14/03/2024", "Not yammy!"),
#     ViewExpense(2, "66,99", "Candies", "01/01/2024", "Yammy x10!"),
# ]
# test_exps2 = [
#     ViewExpense(3, "123", "Milk", "21/02/2024", "Yammy!"),
...
# g.central_widget.expense_add_widget.category_selection.add_category(
#     ViewCategory(0, "root")
# )
# g.central_widget.expense_add_widget.category_selection.add_category(
#     ViewCategory(1, "root2")
# )
# g.central_widget.expense_add_widget.category_selection.add_category(
#     ViewCategory(2, "child", 0)
# )
# g.central_widget.expense_add_widget.category_selection.add_category(
#     ViewCategory(3, "child2", 0)
# )
...
# )
# print(
#     g.central_widget.expense_add_widget.category_selection.update_category(
#         ViewCategory(6, "new root from ch1of2")
#     )
# )
# print(
#     g.central_widget.expense_add_widget.category_selection.update_category(
#         ViewCategory(6, "back from root to r2", 5)
#     )
# )
# g.remove_categories([ViewCategory(6, "child 1 of 1", 0)])
# try:
#     g.remove_categories(
#         [ViewCategory(6, "child 1 of 1", 0), ViewCategory(4, "child 2 of 2", 5)]
#     )
# except Exception:
#     pass
...
# g.central_widget.expense_add_widget.category_selection.register_category_add_handler(
#     add_hndlr
# )
# g.start()
